...
int run()
{
    ...
    Shader shader ("C:/Users/griff/CLionProjects/LearnOpenGL/src/GettingStarted/Transformations/rotatingTexture.vert",
                   "C:/Users/griff/CLionProjects/LearnOpenGL/src/GettingStarted/Transformations/rotatingTexture.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 trans (1.0);
        trans = glm::rotate(trans, glm::radians((float) glfwGetTime() * 50), glm::vec3(1.0, 0.0, 0.0));
