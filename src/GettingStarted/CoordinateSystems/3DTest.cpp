...
int run()
{
    ...
    Shader shader ("C:/Users/griff/CLionProjects/LearnOpenGL/src/GettingStarted/CoordinateSystems/rotatingTexture.vert",
                   "C:/Users/griff/CLionProjects/LearnOpenGL/src/GettingStarted/CoordinateSystems/rotatingTexture.frag");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, glm::radians((float) glfwGetTime() * 50), glm::vec3(1.0, 0.6f, 0.0));
